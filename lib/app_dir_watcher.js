...
class ServiceEntryWatcher extends DirWatcherHandler {
    ...
    add_persistence_service(persistence_link) {
        //
        ...
        this.msg_relay.add_relay_path(this._conf.relayer,path_info)      // add another client 
        ...
        this.msg_relay.subscribe(PUB_TOPIC,persistence_link,{},handler)
        this.msg_relay.subscribe(UNPUB_TOPIC,persistence_link,{},unhandler)
        //
